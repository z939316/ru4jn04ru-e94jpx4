...
int main() {
	int ifv, ifc, ifm;
	float nt = 0;
	char s = 'p', m, r, d, v, awdawd;
	string str = "歡迎光臨成大鍋物，以下將為您介紹本店菜單";
	string str2 = "啊～竟然不是，真是太可惜了，原本想說你是的話我還打算......(店員不經意地露出看起來楚楚可憐的雙眼，她該不會喜歡勤奮而又博學的機械系男生呢？如果剛才回答是，我的人生或許會從此變得不一樣";
	for (char i : str) {
		cout << i;
		Sleep(60);
	}///輸出菜單
	...
	cout << "\n那麼我為您確認一下餐點，如果確認無誤後，之後都是你自己的問題\n首先，你點的湯底是：";
	switch (s) {
	case 'a':
